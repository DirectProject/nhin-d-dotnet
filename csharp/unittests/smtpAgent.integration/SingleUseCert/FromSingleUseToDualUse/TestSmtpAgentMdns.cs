...
namespace Health.Direct.SmtpAgent.Integration.Tests.SingleUseCert.FromSingleUseToDualUse
{
    public class TestSmtpAgentMdns : SmtpAgentTester
    {
        ...
        {
            m_agent = SmtpAgentFactory.Create(GetSettingsPath("TestSmtpAgentConfigService.xml"));
        }
        ...
        public void TestEndToEnd_GatewayIsDestination_Is_True_And_TimelyAndReliable_Not_Requestd()
        {
            ...
            //
            string textMessage = string.Format(string.Format(TestMessageSingleUseToDualUse, Guid.NewGuid()), Guid.NewGuid());
