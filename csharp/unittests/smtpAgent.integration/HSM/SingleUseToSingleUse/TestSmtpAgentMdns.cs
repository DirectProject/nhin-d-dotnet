...
namespace Health.Direct.SmtpAgent.Integration.Tests.HSM.SingleUseToSingleUse
{
    public class TestSmtpAgentMdns : SmtpAgentTester
    {
        ...
        public void TestEndToEnd_GatewayIsDestination_Is_True_And_TimelyAndReliable_Not_Requestd()
        {
            ...
            //
            string textMessage = string.Format(string.Format(TestMessageHsmToHsm, Guid.NewGuid()), Guid.NewGuid());
